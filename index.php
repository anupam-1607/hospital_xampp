            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 col-md-12 left-item">
                        <ul>
                            <li><i class="fas fa-envelope-square"></i> hospital@abc.com</li>
                    ...
                    <div id="menu" class="col-md-9 d-none d-md-block nav-item">
                        <ul>
                            ...
                            <li class="nav-item dropdown">
                                <a class=" dropdown-toggle" href="services.html" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Logins</a>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class="animated bounceInDown">Best Hospital Treatment</h5>
                        <p class="animated bounceInLeft">Nurses may not be angels, but they are the next best thing.</p>
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="assets/images/slider/slider_3.jpg" alt="Third slide">
                     <div class="carousel-caption vdg-cur d-none d-md-block">
                        ...
                        <p class="animated bounceInLeft">Healing in a matter of time, but it is sometimes also a matter of opportunity..</p>
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="assets/images/slider/222.jpg" alt="Second slide">
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Best Free Hospital Template</h5>
                        <p class="animated bounceInLeft"> This life is a hospital in which every patient is possessed with a desire to change his bed.</p>
