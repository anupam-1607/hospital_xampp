...
<head>
    ...
    <script src="../js/c_user.js" type="text/javascript"></script>
            ...
            <div class="row clearfix">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable" id=tab>
                                    ...
                                    <?php
                                        include_once '../action/classis/db_user.php';
                                        $t=new demo();
                                        $t->tab();
                                    ?>
             ...
             <?php
                            ...
                            if(isset($_POST['search']))
                            {
                                ...
                                $query = "SELECT * FROM `user` WHERE CONCAT(`register_date`, `fname`, `lname`, `email`, `city`, `pass`, `gender`) LIKE '%".$valueToSearch."%'";
